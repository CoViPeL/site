...
const siteSettings = {
  name: 'CoViPeL',
  EULA: 'https://github.com/CoViPeL/covipel/blob/main/EULA.md',
};
  ...
  return (
    ...
    >
      ...
      <div className="w-full py-16 bg-primary h-full text-center">
        ...
        <div className="py-16">
          <p className="p-2"> Before using CoViPeL, please read and agree to the terms outlined in the End-User License Agreement (EULA). </p>
